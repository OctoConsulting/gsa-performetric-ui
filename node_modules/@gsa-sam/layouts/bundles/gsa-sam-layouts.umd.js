(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@gsa-sam/sam-formly'), require('rxjs'), require('@angular/core'), require('@gsa-sam/components'), require('@angular/common'), require('@fortawesome/angular-fontawesome')) :
    typeof define === 'function' && define.amd ? define('@gsa-sam/layouts', ['exports', '@angular/forms', '@gsa-sam/sam-formly', 'rxjs', '@angular/core', '@gsa-sam/components', '@angular/common', '@fortawesome/angular-fontawesome'], factory) :
    (factory((global['gsa-sam'] = global['gsa-sam'] || {}, global['gsa-sam'].layouts = {}),global.ng.forms,global.samFormly,global.rxjs,global.ng.core,global.components,global.ng.common,global.angularFontawesome));
}(this, (function (exports,forms,samFormly,rxjs,core,components,common,angularFontawesome) { 'use strict';
    ...
    var SearchListLayoutComponent = /** @class */ (function () {
        function SearchListLayoutComponent(formlyUpdateComunicationService) {
             ...
             * Page event listener
             */
            this.paginationChange = new rxjs.BehaviorSubject(this.page);
            /**
        ...
        /** @nocollapse */
        SearchListLayoutComponent.ctorParameters = function () {
            return [
                { type: samFormly.SDSFormlyUpdateComunicationService, decorators: [{ type: core.Optional }] }
            ];
        };
        ...
        SearchListServiceModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            components.PaginationModule, components.SdsSearchResultListModule
    ...
    var SdsSubheaderDrawerComponent = /** @class */ (function () {
        function SdsSubheaderDrawerComponent(data) {
            this.data = data;
            this.isDrawerOpen = new core.EventEmitter();
            this.isOpen = false;
        }
        /**
         * @param {?} ev
        ...
        /** @nocollapse */
        SdsSubheaderDrawerComponent.ctorParameters = function () {
            return [
                { type: SdsDrawerCommunicationService }
            ];
        };
        SdsSubheaderDrawerComponent.propDecorators = {
            drawerContentTemplate: [{ type: core.Input }],
            isDrawerOpen: [{ type: core.Output }]
        };
    ...
    var SdsDrawerContentComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        SdsDrawerContentComponent.ctorParameters = function () {
            return [
                { type: SdsDrawerCommunicationService }
            ];
        };
    ...
    var SdsActionsMenuModule = /** @class */ (function () {
        ...
        SdsActionsMenuModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, angularFontawesome.FontAwesomeModule, components.SdsMenuModule],
        ...
        SdsSubheaderModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            components.SdsMenuModule,
                            components.SdsObserversModule,
                            components.SdsSearchModule,
                            components.SdsTruncateModule,
    ...
    exports.PackagesLayoutsModule = PackagesLayoutsModule;
    exports.SearchListServiceModule = SearchListServiceModule;
    exports.SearchParameters = SearchParameters;
    exports.SearchResult = SearchResult;
    exports.sortItem = sortItem;
    exports.SearchListConfiguration = SearchListConfiguration;
    exports.SdsSubheaderModule = SdsSubheaderModule;
    exports.SdsActionsMenuModule = SdsActionsMenuModule;
    exports.ɵb = SdsActionsMenuComponent;
    exports.ɵa = SearchListLayoutComponent;
    exports.ɵg = SdsDrawerCommunicationService;
    exports.ɵf = SdsDrawerContentComponent;
    exports.ɵd = SdsSubheaderActionsComponent;
    exports.ɵc = SdsSubheaderComponent;
    exports.ɵe = SdsSubheaderDrawerComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsa-sam-layouts.umd.js.map