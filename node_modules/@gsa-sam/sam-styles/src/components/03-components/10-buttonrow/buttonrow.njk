...
<p>Or use circular buttons and labels</p>
  ...
  <div class="sds-button-row">
    <div class="sds-button-col sds-button-col--left">
      <button id="back" class="sds-button--circle usa-button--secondary">
    ...
    <div class="sds-button-col">
      <button id="cancel" class="sds-button--circle usa-button--secondary">
        {% render '@icon', {icon:'times', prefix: 'fa'} %}
      </button>
      <label for="cancel">Cancel</label>
    </div>
    <div class="sds-button-col">
      <button id="help" class="sds-button--circle usa-button--secondary">
        {% render '@icon', {icon:'caret-down', prefix: 'fa'} %}
      </button>
      <label for="help">Help</label>
    </div>
    <div id="forward" class="sds-button-col sds-button-col--right">
      <button class="sds-button--circle usa-button--secondary">
