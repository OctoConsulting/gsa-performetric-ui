<div class="Browser-panel" data-role="tab-panel" id="browser-{{ entity.id }}-panel-info">
    <ul class="Meta">
        ...
        <li class="Meta-item">
            ...
            <span class="Meta-value">
                <ul>
                    ...
                    <li><a id="stackblitzLink" href=""><span>Stackblitz</span> {% include "icons/open-in-browser.svg" %}</a></li>
                </ul>
            </span>
        </li>
        <li class="Meta-item">
            <strong class="Meta-key">Filesystem Path:</strong>
            <span class="Meta-value">{{entity.context.scss}} - {{ entity.viewPath | componentPath }}</span>
        </li>
        {% if entity.references.length %}
        <li class="Meta-item">
            <strong class="Meta-key">Uses <em class="Meta-count">({{ entity.references.length }})</em>:</strong>
            <span class="Meta-value Meta-value--linkList">
        ...
        <li class="Meta-item">
            <strong class="Meta-key">Used in <em class="Meta-count">({{ entity.referencedBy.length }})</em>:</strong>
            <span class="Meta-value Meta-value--linkList">
...
<script>
  ...
  const project = {
    files: {
      'index.html': `{{ entity.render(null, renderEnv) | async | trim }}`,
      'index.js': ``,
    },
    title: 'SAM Styles',
    description: 'SAM Styles - {{ entity.title }} example',
    template: 'javascript'
  };
    
  stackblitzLink = document.getElementById('stackblitzLink');
  stackblitzLink.onclick = function(){
