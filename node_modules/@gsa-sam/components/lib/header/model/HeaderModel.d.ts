...
export declare class HeaderHome implements Selectable, INavigationLink {
    /**
 ...
 *
 */
export declare class HeaderNavigationLink implements Selectable, INavigationLink {
    /**
     * Internal Angualr Routes, External HREF, EVENT: event on parent component
     */
    mode: NavigationMode;
...
export declare class HeaderSecondaryLink implements Selectable, INavigationLink {
    /**
     * Internal Angualr Routes, External HREF, EVENT: event on parent component
     */
    mode: NavigationMode;
