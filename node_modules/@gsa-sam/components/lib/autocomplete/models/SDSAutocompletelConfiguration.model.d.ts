...
export declare class SDSAutocompletelConfiguration implements SDSSelectedResultConfiguration, SDSAutocompleteSearchConfiguration {
    /**
     ...
     */
    minimumCharacterCountSearch: number;
    /**
