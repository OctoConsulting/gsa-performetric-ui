(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs/operators'), require('@angular/core'), require('@angular/platform-browser'), require('@angular/forms'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/core', ['exports', '@angular/common', 'rxjs/operators', '@angular/core', '@angular/platform-browser', '@angular/forms', 'rxjs'], factory) :
    (factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].core = {}),global.ng.common,global.rxjs.operators,global.ng.core,global.ng.platformBrowser,global.ng.forms,global.rxjs));
}(this, (function (exports,common,operators,i0,platformBrowser,forms,rxjs) { 'use strict';
